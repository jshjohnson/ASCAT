...
# Configure these
set :site,         "156312" # this is your site number, for example if your access domain is s12345.gridserver.com
...
after "deploy:finalize_update" do
  redmonster.symlinks
  run "cp #{current_release}/wp-config-#{stage}.php #{current_release}/wp-config.php"
end